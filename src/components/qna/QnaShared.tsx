...
interface MyActivityPanelProps {
   ...
   * 이 패널은 /qna/activity로 가는 앱 내 유일한 진입점이다. 그 보장은 **허브(QnaHomeClient)가**
   * 진다 — 사이드바가 밀리는 폭에서는 compact 사본을 본문 상단으로 끌어올려, 어느 폭에서도
   * 통로가 하나는 살아 있다. 상세(QnaDetailClient)는 그 보장의 사본일 뿐이라 ≤1040px에서 면제한다.
   * 상세 1열에서는 댓글 전체 아래로 밀려 도달률이 0에 수렴하는데, 그 자리를 지키는 것이
   * 진입점을 지키는 일은 아니기 때문이다. 허브 쪽 세 구간(≤760 / 761~1040 / ≥1041)을 지우지 말 것.
   */
