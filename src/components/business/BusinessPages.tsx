    ...
    <>
      ...
      <main className="min-h-[calc(100vh-64px)] bg-[#f5f6f7]">
        <section className="app-shell py-16">
          <div className="grid grid-cols-[minmax(0,1fr)_360px] border border-border bg-white max-[900px]:grid-cols-1">
            <div className="p-10 max-[760px]:p-6">
              <Eyebrow>기업 서비스</Eyebrow>
              <h1 className="mt-3 text-[34px] font-bold leading-[1.2] tracking-[-0.02em] text-[#242b36] max-[760px]:text-[26px]">기업 계정으로 시작하세요</h1>
            ...
            <div
              className="min-h-[320px] border-l border-border bg-cover bg-center max-[900px]:hidden"
              style={{
                backgroundImage:
