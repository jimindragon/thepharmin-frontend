    ...
    <>
      ...
      <main className="min-h-[calc(100vh-64px)] bg-[#f5f6f7] pb-24">
        ...
        <div className="app-shell pt-6">
          ...
          <h1 className="mt-5 max-[760px]:mt-0 text-[34px] font-bold leading-[1.2] tracking-[-0.02em] text-[#242b36]">브랜드 페이지 미리보기</h1>
          <p className="mt-2 text-[15px] font-normal leading-[1.7] text-[#68717e]">구직자에게 노출되는 {trackLabel} 상세 페이지를 그대로 확인할 수 있는 읽기 전용 화면입니다.</p>
