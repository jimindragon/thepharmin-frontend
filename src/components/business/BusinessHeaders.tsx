...
const publicNavItems = [
  { label: "채용상품 안내", href: "/business/products" },
...
function BusinessBrand({ homeHref }: { homeHref: string }) {
  return (
    <Link href={homeHref} className="flex shrink-0 items-center gap-3" aria-label="더파마 리크루트 기업 서비스 홈">
      ...
      <span className="whitespace-nowrap text-[13px] font-black text-[#68717e] max-[420px]:text-[12px]">기업</span>
    </Link>
  );
}
    ...
    <header className="site-header sticky top-0 z-50 h-[64px] border-b border-[#dfe4ea] bg-white text-[#17202c]">
      <div className="app-shell flex h-full items-center gap-6 max-[900px]:gap-4 max-[520px]:gap-3">
            ...
            return (
              <Link
                ...
                className={clsx(
                  ...
                  active
                    ? "relative font-black text-[#00746c] after:absolute after:-bottom-[22px] after:left-0 after:h-[3px] after:w-full after:bg-[#00746c]"
                    : "font-semibold text-[#4f5967] hover:text-[#111111]",
                )}
              >
                {item.label}
              </Link>
        ...
        <div className="ml-auto flex items-center gap-2.5 max-[520px]:gap-1.5">
          <Link href="/business/login" className="hidden h-10 items-center px-3 text-[12px] font-black text-[#4f5967] hover:text-[#111111] sm:inline-flex">
            로그인
          </Link>
          <Link href="/business/signup" className="hidden h-10 items-center border border-[#cfd8e3] px-3 text-[12px] font-black text-[#303946] hover:border-[#111111] md:inline-flex">
            기업 계정 신청
          </Link>
          <Link href="/business/login" className="inline-flex h-10 items-center bg-[#00746c] px-3.5 text-[12px] font-black text-white hover:bg-[#075f59] max-[520px]:hidden">
            공고 등록하기
          </Link>
        </div>
      </div>
    ...
    <header className="site-header sticky top-0 z-50 h-[64px] border-b border-[#dfe4ea] bg-white text-[#17202c]">
      <div className="app-shell flex h-full items-center gap-6 max-[900px]:gap-4 max-[520px]:gap-3">
        ...
        <div className="ml-auto flex items-center gap-2.5 max-[520px]:gap-1.5">
          ...
          <button type="button" className="flex h-10 items-center gap-2 border border-[#d7dde5] px-2.5 text-[12px] font-black text-[#303946] hover:border-[#111111] max-[640px]:hidden">
          ...
          <Link href="/business/jobs/new" className="inline-flex h-10 items-center justify-center gap-1.5 bg-[#00746c] px-3.5 text-[12px] font-black text-white hover:bg-[#075f59] max-[520px]:w-10 max-[520px]:px-0">
            <Plus size={15} />
