...
export const jobs: Job[] = [
  ...
  ...[
    ...
    // [공고 F] 한국뇌연구원 치매연구그룹 (박사후 연수연구원)
    {
      ...
      location: "대구",
      salary: "연봉 4,500만원",
      tags: ["포닥", "PM2.5", "뇌질환", "IHC"],
      deadlineLabel: "마감 D-67",
      ...
      companyTypeId: "pharma",
      researchInstitutionTypeIds: ["government_research_institute"],
      researchFieldIds: ["molecular-biology", "neurobiology", "bio-medical-convergence-field"],
      contractPeriodIds: ["1-2-years"],
    ...
    // [공고 G] University of North Texas 뇌 오가노이드 (해외·J-1, PostDoc)
    {
      ...
      tags: ["포닥", "iPSC", "brain organoid", "CRISPR"],
      deadlineLabel: "마감 D-67",
      deadlineDate: "2026년 9월 7일 마감",
      closingStatus: "dDay",
      applyMethod: "이메일 지원",
      ...
      companyTypeId: "pharma",
      researchInstitutionTypeIds: ["university_lab"],
      researchFieldIds: ["molecular-biology", "neurobiology", "bioengineering"],
      contractPeriodIds: ["1-2-years"],
      searchKeywords: [
    ...
    // [공고 H] 포항공과대학교 생명과학과 구조생물학 연구원
    {
      ...
      tags: ["연구원", "구조생물학", "cloning", "protein purification"],
      deadlineLabel: "마감 D-54",
      ...
      companyTypeId: "pharma",
      researchInstitutionTypeIds: ["university_lab"],
      researchFieldIds: ["structural-biology"],
      contractPeriodIds: ["1-2-years"],
    ...
    // [공고 I] 동국대학교 약학대학 약물학/약동학 실험실
    {
      ...
      tags: ["연구원", "PK-PD", "DMPK", "LC-MS/MS"],
      deadlineLabel: "마감 D-29",
      deadlineDate: "2026년 7월 31일 마감",
      closingStatus: "dDay",
      applyMethod: "이메일 지원",
      jobSubcategoryIds: ["research_scientist"],
    ...
    // [공고 J] 부산대학교 구강점막면역 연구실
    {
      ...
      location: "경남",
      salary: "연봉 2,600만~3,000만원",
      tags: ["연구원", "점막면역", "숙주-미생물 상호작용", "동물모델"],
      deadlineLabel: "마감 D-26",
      ...
      companyTypeId: "pharma",
      researchInstitutionTypeIds: ["university_lab"],
      researchFieldIds: ["molecular-cell-medicine", "immunology", "infection-biology"],
      contractPeriodIds: ["1-2-years"],
    ...
    // [공고 K] 건양대학교 명곡안연구소
    {
      ...
      companyTypeId: "pharma",
      researchInstitutionTypeIds: ["university_lab"],
      researchFieldIds: ["life-science-etc"],
      contractPeriodIds: ["1-2-years"],
    ...
    // [공고 L] 한림대학교 의과대학 미생물학교실 랩매니저
    {
      ...
      companyTypeId: "pharma",
      researchInstitutionTypeIds: ["university_lab"],
      researchFieldIds: ["infectious-medicine", "microbiology", "bio-medical-convergence-field"],
      contractPeriodIds: ["1-2-years"],
    ...
    // [공고 M] 인제대학교 심혈관 및 대사질환 핵심연구지원센터
    {
      ...
      companyTypeId: "pharma",
      researchInstitutionTypeIds: ["university_lab"],
      researchFieldIds: ["physiology", "applied-medicine"],
      contractPeriodIds: ["1-2-years"],
  ...
  ...[
    ...
    },
    {
      ...
      salary: "일급 500,000원",
      tags: ["파트타임약사", "일반약국", "경력 1년 이상", "대졸4년제", "충북 영동군"],
      deadlineLabel: "채용시 마감",
      deadlineDate: "채용시 마감",
      closingStatus: "always",
      applyMethod: "간편 지원",
    ...
    },
    {
      ...
      salary: "월급 420만원",
      tags: ["풀타임약사", "의원층약국", "무관", "학력무관", "충북 청주시"],
      deadlineLabel: "채용시 마감",
      deadlineDate: "채용시 마감",
      closingStatus: "always",
      applyMethod: "간편 지원",
    ...
    },
    {
      ...
      salary: "시급 45,000원",
      tags: ["파트타임약사", "의원층약국", "무관", "대졸4년제", "경남 창원시"],
      deadlineLabel: "채용시 마감",
      deadlineDate: "채용시 마감",
      closingStatus: "always",
      applyMethod: "문자",
      ...
      workModeIds: ["onsite"],
      companyTypeId: "pharmacy",
      pharmacyWorkTypeIds: ["part_time", "weekend_night"],
    ...
    },
    {
      ...
      employmentType: "프리랜서",
      location: "서울 중구",
      address: "서울 중구 퇴계로 436",
      salary: "시급 32,000~35,000원",
      tags: ["파트타임약사", "일반약국", "경력 1년 이상", "대졸4년제", "서울 중구"],
      deadlineLabel: "채용시 마감",
      deadlineDate: "채용시 마감",
      closingStatus: "always",
      applyMethod: "간편 지원",
      ...
      pharmacyFeatureIds: [],
      scheduleIds: ["weekend"],
      searchKeywords: ["파트타임약사", "신중앙약국", "신당역", "서울 중구", "토요일"],
      industry: "일반약국",
      coverImageMode: "none",
    ...
    },
    {
      ...
      salary: "일급 400,000원",
      tags: ["단기대체약사", "일반약국", "경력 1년 이상", "대졸4년제", "경북 경주시"],
    ...
    },
    {
      ...
      salary: "면접 후 결정",
      tags: ["풀타임약사", "일반약국", "경력 1년 이상", "대졸4년제", "충남 천안시"],
      deadlineLabel: "채용시 마감",
      deadlineDate: "채용시 마감",
      closingStatus: "always",
      applyMethod: "간편 지원",
